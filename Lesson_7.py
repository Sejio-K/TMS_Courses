...
'''Задание 2: написать программу для вычисления факториала.
Факториал - 1 * 2 * 3 ... * n'''
...
'''Задание 4: написать функцию для определения наибольшего числа
(реализовать свой max)'''
...
'''Задание 5: написать функцию, которая извлекает подстроку из
строки без использования стандартных функций для работы со строкой
список задач'''
...
'''Задание 6: написать функцию, которая находит максимальное
значение в списке (без использования функции max) и с использованием
цикла while'''
...
'''Задача 7: написать функцию, которая принимает список, отфильтровывает
нечетные значения и возвращает True, если все четные > 0 иначе False'''
...
'''Задача 8: написать функцию, которая принимает в себя время в виде
"HH:mm:ss" и считает, сколько всего секунд'''
